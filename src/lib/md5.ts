/**
 * MD5 (RFC 1321), hand-rolled because WebCrypto does not offer it.
 * Implements the full algorithm for arbitrary byte input; returns raw bytes.
 * MD5 is broken for security purposes — offered for checksums / legacy only.
 */
...
export function md5(data: Uint8Array): Uint8Array {
  ...
  // Pad: 0x80, zeros to 56 mod 64, then 64-bit little-endian length.
